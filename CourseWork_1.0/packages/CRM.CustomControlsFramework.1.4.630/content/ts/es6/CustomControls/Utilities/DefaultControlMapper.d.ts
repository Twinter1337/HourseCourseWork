...
declare function retrieveDefaultConfigurationForQuickFormChartControl(parameters: CustomControlInterfaces.IChartCustomControlDescriptorParameters, dataRequestType?: CustomControlInterfaces.FirstDataRequestType): CustomControlInterfaces.ICustomControlConfiguration;
declare function retrieveDefaultConfigurationForFormChartControl(parameters: CustomControlInterfaces.IChartCustomControlDescriptorParameters, firstDataRequestType?: CustomControlInterfaces.FirstDataRequestType): CustomControlInterfaces.ICustomControlConfiguration;
