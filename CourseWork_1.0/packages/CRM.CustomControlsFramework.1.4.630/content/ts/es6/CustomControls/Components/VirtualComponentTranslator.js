...
import { Flyout, InnerFlyout } from "../../CommonComponents/Primitive/Flyout";
...
import { FIELD_SECTION_ITEM_ID, IFRAME_CLASS_ID } from "../Utilities/DefaultControlMapper";
...
var VirtualComponentTranslator = (function () {
    ...
    VirtualComponentTranslator.generateJSXElement = function (elementType, props, children, ownProps, hostData, complexKeeper) {
        ...
        switch (elementType.toUpperCase()) {
            ...
            case "IFRAME":
                ...
                var isDefaultIframecontrol = ownProps.descriptor.ClassId && areGuidsSame(IFRAME_CLASS_ID, ownProps.descriptor.ClassId.guid);
            ...
            case "POPUP":
                ...
                var component = React.createElement(Popup, __assign({}, popupProps, { id: popupProps.id, children: children }));
                if (popupProps.type === PopupType.Root) {
                    return (React.createElement(RootPopup, { key: popupProps.key, parentCustomControlId: ownProps.controlId, id: popupProps.name, openPopup: ownProps.actions.openPopup, closePopup: ownProps.actions.closePopup, rootNodes: ownProps.popupRootNodes }, component));
                }
                return component;
            case "FLYOUT":
                var flyoutProps = props;
                var prefixedRelativeToElementId = buildUniqueCustomControlId(ownProps, flyoutProps.relativeToElementId, props.absoluteId);
                var customControlElementId = buildUniqueCustomControlId(ownProps, flyoutProps.focusElementId, props.absoluteId);
    ...
    VirtualComponentTranslator._generateFlyoutParentId = function (hostProps, component) {
        ...
        if (component.getType().toUpperCase() === "FLYOUT") {
            ...
            return InnerFlyout.generateFlyoutId(hostProps.controlId, props.groupId);
        }
        return null;
    };
    ...
    VirtualComponentTranslator.isComplexComponent = function (virtualComponent) {
        ...
        if (type && SupportedPrimitives.indexOf(type.toUpperCase()) !== -1) {
            return false;
        }
        return true;
    };
