...
var InnerHorizontalScroll = (function (_super) {
    ...
    InnerHorizontalScroll.prototype._renderNextArrowButton = function () {
        ...
        return (React.createElement(Button, { id: id, key: id, accessibilityHidden: this.state.nextArrowDisabled, accessibilityLabel: this.props.isRTL ? "Scroll left the content" : "Scroll right the content", accessibilityHasPopup: true, tabIndex: -1, disabled: this.state.nextArrowDisabled, style: buttonNextStyle, onFocus: this.props.onFocus, onClick: this._onNextClick, onKeyDown: this._onNextKeyDown }, this.props.isRTL ? this._getPrevIcon() : this._getNextIcon()));
    };
